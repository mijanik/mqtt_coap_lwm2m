...
embenet_node_port/src/%.o embenet_node_port/src/%.su: ../embenet_node_port/src/%.c embenet_node_port/src/subdir.mk
...
clean-embenet_node_port-2f-src:
	-$(RM) ./embenet_node_port/src/embenet_aes128.d ./embenet_node_port/src/embenet_aes128.o ./embenet_node_port/src/embenet_aes128.su ./embenet_node_port/src/embenet_brt.d ./embenet_node_port/src/embenet_brt.o ./embenet_node_port/src/embenet_brt.su ./embenet_node_port/src/embenet_capabilities.d ./embenet_node_port/src/embenet_capabilities.o ./embenet_node_port/src/embenet_capabilities.su ./embenet_node_port/src/embenet_critical_section.d ./embenet_node_port/src/embenet_critical_section.o ./embenet_node_port/src/embenet_critical_section.su ./embenet_node_port/src/embenet_eui64.d ./embenet_node_port/src/embenet_eui64.o ./embenet_node_port/src/embenet_eui64.su ./embenet_node_port/src/embenet_radio.d ./embenet_node_port/src/embenet_radio.o ./embenet_node_port/src/embenet_radio.su ./embenet_node_port/src/embenet_random.d ./embenet_node_port/src/embenet_random.o ./embenet_node_port/src/embenet_random.su ./embenet_node_port/src/embenet_timer.d ./embenet_node_port/src/embenet_timer.o ./embenet_node_port/src/embenet_timer.su ./embenet_node_port/src/radio_driver.d ./embenet_node_port/src/radio_driver.o ./embenet_node_port/src/radio_driver.su
